    ...
    <section className="bg-parchment-200 py-14">
      <Container>
        ...
        >
          ...
          <div className="relative z-10 px-6 py-10 sm:px-10 sm:py-12 lg:max-w-[60%]">
            <p className="kicker text-saffron-300">B2B</p>
            <h3 className="display mt-3 text-parchment-50 text-[clamp(1.45rem,2.6vw,2.25rem)] leading-snug">
              {data.text}
            </h3>
            <div className="mt-7">
              <Link
                href="/b2b"
                className="group/btn inline-flex items-center gap-2.5 rounded-[2px] bg-saffron-500 px-6 py-3 text-sm font-semibold text-onyx transition-colors hover:bg-saffron-400"
              >
                {data.cta}
